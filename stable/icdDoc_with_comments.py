...
En esta secci\\'on se presenta el nodo l\\'ogico \\textbf{%s}.
En la tabla \\ref{%s} se pueden visualizar
las instancias que han sido utilizadas, y en tabla \\ref{%s}
se presenta el tipo de nodo l\\'ogico
correspondiente (\\textbf{LNType}, del elemento \\textbf{DataTypeTemplates}).

""" % (lnClass.value, lnClass.value, referenciaTablaLnInst, referenciaTablaLNType)
    ...
    Lista de los nodos l\\'ogicos implementados en el IED \\textbf{%s}.
    \\begin{table}[H]
    \\begin{center}
...
###        print lNodeTypeList[-1]
    ...
    Plantilla \\textbf{LNType} utilizada para este nodo l\\'ogico.
    \\begin{table}[H]
    \\begin{center}
